      ...
      <div id="navbar" class="navbar navbar-dark bg-dark shadow-sm">
        <div class="container d-flex justify-content-between">
          <div class="navbar-brand d-inline align-items-center">
              ...
              <?php
                if ($_SESSION['admin'] == 1) {
                    echo '<a href="home-admin.php" class="navbar-brand d-inline align-items-center text-right"><i class="fas fa-sign-out-alt"></i><strong>Admin Home</strong></a>';
                }
              ?>
          </div>
          <div class="inline">
            <a href="profile.php" class="navbar-brand d-inline align-items-center text-right">
            ...
            <a href="shoppingcart.php" class="navbar-brand d-inline align-items-center text-right">
    ...
    <main role="main">
      <section class="jumbotron text-center">
        <div class="container">
          ...
          <p class="lead text-muted">You can make you choice at this page.</p>
          ...
          success: function(data) {
            ...
            for (var i = 0; i < json.length; i++) {
              ...
              if (i >= startIndex & i < endIndex) {
                $("#pizzaList").append('<div class="col-md-4"><div class="card mb-4 shadow-sm"><img class="card-img-top" src="' + item.name + '.jpg"><div class="card-body"><form action="to_cart.php" method="get"><div class="d-flex justify-content-between"><h4 class="card-text" >' + item.name + '</h4></div><p class="card-text">' + item.description + '</p><div class="d-flex justify-content-between align-items-center"><div class="btn-group"><select required class="custom-select" name="size" id="inputGroupSelect01" style="margin-right: 1%"><option value="" disabled selected>Size...</option><option value="10">10</option><option value="12">12</option><option value="14">14</option><option value="16">16</option></select><input name="name" value="' + item.name + '" style="display:none"><input type="text" class="form-control" placeholder="Quantity" name="quantity" value="" style="margin-right: 1%" required><button type="submit" class="btn btn-sm btn-outline-secondary">Order</button></div></div></form></div></div></div>');
              }
            }
          }
        });
